...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  weltfair: {
    eyebrow: 'Weltfair',
    title: 'Unser Weltfair-Blog',
    lead: 'Geschichten, Reportagen und Hintergründe rund um fairen Handel, globale Verantwortung und die Menschen hinter unseren Produkten.',
    intro: 'Weltfair ist unser Schaufenster für Themen, die über den Alltag hinausgehen: Wie sieht faire Produktion in unseren Lieferketten aus? Welche Initiativen unterstützen wir weltweit? Und welche Geschichten erzählen unsere Partner:innen? Hier sammeln wir Beiträge, die zeigen, dass Hilfsmittel mehr sind als nur Produkte — nämlich Teil einer Bewegung für mehr Gerechtigkeit.',
    postsHeading: 'Aktuelle Beiträge',
    posts: [
      {
        category: 'Fairer Handel',
        title: 'Was fairen Handel wirklich ausmacht',
        excerpt: 'Fairer Handel ist mehr als ein Siegel — wir zeigen, was hinter Zertifikaten steckt, wie Lieferketten transparent werden und welche Wirkung Ihr Einkauf tatsächlich erzielt.',
        image: '',
        meta: 'Anna Vogt · 12. Mai 2026',
        href: '/weltfair',
      },
      {
        category: 'Global',
        title: 'Unsere Partner in Südostasien',
        excerpt: 'Reisebericht aus Vietnam und Indonesien: Wie unsere Hilfsmittel-Produktion vor Ort funktioniert, welche Standards gelten und welche Geschichten hinter den Lieferketten stecken.',
        image: '',
        meta: 'Klaus Werner · 28. April 2026',
        href: '/weltfair',
      },
      {
        category: 'Lieferkette',
        title: 'Vom Rohstoff bis zum Pflegebett',
        excerpt: 'Eine Hilfsmittel-Lieferkette ist komplex. Wir nehmen Sie mit auf den Weg — vom Stahlwerk bis zur Auslieferung beim Pflegedienst, mit allen Stationen dazwischen.',
        image: '',
        meta: 'Markus Lehner · 15. April 2026',
        href: '/weltfair',
      },
      {
        category: 'Verantwortung',
        title: 'Warum faire Preise auch uns verändern',
        excerpt: 'Faire Löhne, faire Margen, faire Preise: Warum wir uns bewusst gegen den billigsten Anbieter entscheiden — und warum das langfristig für alle Beteiligten besser ist.',
        image: '',
        meta: 'Sophia Bach · 02. April 2026',
        href: '/weltfair',
      },
    ],
  },
  ...
  wirsuchensie: {
    eyebrow: 'Wir suchen Sie',
    title: 'Werden Sie Teil unseres Teams',
    lead: 'Erfahrene Pflege-Profis, Berater:innen, IT-Spezialist:innen und Quereinsteiger:innen gesucht — werden Sie Teil einer Mission, die wirklich zählt.',
    intro: 'Bei prosozial zu arbeiten bedeutet, jeden Tag einen Unterschied im Leben anderer Menschen zu machen. Ob in der Beratung, in der Logistik, in der Verwaltung oder im IT-Bereich — wir suchen Menschen, die mit Herz, Verstand und Engagement die Versorgung von Pflegebedürftigen in Deutschland mitgestalten. Wir bieten faire Bezahlung, echte Entwicklungschancen und ein werteorientiertes Team, das sich gegenseitig trägt.',
    jobsHeading: 'Offene Stellen',
    jobs: [
      {
        category: 'Pflege & Beratung',
        title: 'Pflegeberater:in (m/w/d)',
        excerpt: 'Sie beraten Pflegebedürftige und Angehörige zu unseren Hilfsmitteln, erstellen individuelle Versorgungspläne und begleiten die Kund:innen von der ersten Beratung bis zur Abrechnung mit der Pflegekasse.',
        image: '',
        meta: 'Lahnstein · Vollzeit',
        href: '/wirsuchensie',
      },
      {
        category: 'Kundenservice',
        title: 'Mitarbeiter:in Kundensupport (m/w/d)',
        excerpt: 'Sie beantworten Anfragen per Telefon und E-Mail, helfen unseren Kund:innen bei der Auswahl der passenden Hilfsmittel und sorgen für eine hohe Zufriedenheit in jeder Kontaktanfrage.',
        image: '',
        meta: 'Lahnstein · Voll- oder Teilzeit',
        href: '/wirsuchensie',
      },
      {
        category: 'Logistik & Versand',
        title: 'Mitarbeiter:in Logistik (m/w/d)',
        excerpt: 'Sie kommissionieren Hilfsmittel, verpacken Bestellungen sorgfältig und bereiten Sendungen für den Versand vor. Mit Ihrer Sorgfalt sorgen Sie dafür, dass jede Lieferung pünktlich und unversehrt ankommt.',
        image: '',
        meta: 'Lahnstein · Vollzeit',
        href: '/wirsuchensie',
      },
      {
        category: 'Verwaltung',
        title: 'Sachbearbeiter:in Pflegekasse-Abrechnung (m/w/d)',
        excerpt: 'Sie bearbeiten die Abrechnung unserer Hilfsmittel mit den gesetzlichen Pflegekassen, prüfen Kostenzusagen und sorgen für eine korrekte und pünktliche Abwicklung mit den Kostenträgern.',
        image: '',
        meta: 'Lahnstein · Voll- oder Teilzeit',
        href: '/wirsuchensie',
      },
